...
import re
import math
from app.utils import load_image, align_top_left, ease_out_back_interpolate, smoothstep_interpolate, ease_out_elastic_interpolate
...
class Notification():
    def __init__(self, surface, message, Timing, Sound, type, RENDER_SCALE = 1):
        ...
        self.image_width = int(35 * self.RENDER_SCALE)
