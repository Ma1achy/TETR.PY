import pygame
import json
from app.render.GUI.menu_elements.header import Header
from app.render.GUI.menu_elements.footer import Footer
from app.render.GUI.main_body import MainBody
from app.render.GUI.buttons.footer_button import FooterButton
from app.render.GUI.font import Font
import re
from app.utils import apply_gaussian_blur_with_alpha, smoothstep
