...
class MenuManager():
    ...
    def init_menus(self, window):
        ...
        self.EditARRDialog = DialogBox(
            ...
            message = "The time interval between each automatic repeat movement a tetromino performs when holding down the movement keys, measured in ms." ,
        ...
        self.EditDASDialog = DialogBox(
            ...
            message = "The time interval between the initial key press and the automatic repeat movement, measured in ms." ,
            buttons = ['CANCEL', 'SUBMIT'],
            funcs = [self.close_dialog, lambda: None], 
            click_off_dissmiss = True, 
            width = 550, 
        ...
        self.EditDCDDialog = DialogBox(
            ...
            self.RenderStruct, 
            title = 'DAS CUT DELAY',
            message = "If non-zero, any ongoing DAS movement will pause for a set amount of time after dropping or rotating a piece, measured in ms." ,
            buttons = ['CANCEL', 'SUBMIT'],
            funcs = [self.close_dialog, lambda: None], 
            click_off_dissmiss = True, 
            width = 550, 
