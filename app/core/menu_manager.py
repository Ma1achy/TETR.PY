...
class MenuManager():
    ...
    def init_menus(self, window):
        ...
        self.EditARRDialog = DialogBox(
            ...
            message = "The time interval between each repeat movement a tetromino does when holding down the movement keys, measured in ms." ,
        ...
        self.EditDASDialog = DialogBox(
            ...
            message = "The time between the initial key press and the automatic repeat movement, measured in ms." ,
            buttons = ['CANCEL', 'SUBMIT'],
            funcs = [self.close_dialog, lambda: None], 
            click_off_dissmiss = True, 
            width = 550, 
