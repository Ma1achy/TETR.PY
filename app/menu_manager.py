...
class MenuManager():
    ...
    def init_menus(self, window):
        self.window = window
        self.ExitDialog = DialogBox(self.window, self.Mouse, self.RenderStruct, 'EXIT TETR.PY?', None, buttons = ('CANCEL', 'EXIT'), funcs = (self.close_exit_dialog, self.quit_game), click_off_dissmiss = True)
